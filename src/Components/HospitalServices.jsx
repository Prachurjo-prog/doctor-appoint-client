      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center justify-center px-4">
        ...
        >
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-5 text-[16px] text-[#262626] max-w-90 font-medium mx-auto lg:mx-0">
              Our providers are qualified to help with many behavioral health needs.
            </p>
            <button className="mt-7 border border-blue-500 text-blue-500 rounded-full px-8 h-11.5 text-[13px] font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300">
